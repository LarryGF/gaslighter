...
Combined: 1234 cells. `hard-buried-constraints` and `hard-cascade-update` are covered by all 9 runs (n=58/arm each, pooled); `hard-implicit-patterns`, `hard-preserve-behavior`, and `hard-trailing-reqs` come from 8 of the 9 runs only (n=42/arm each); `hard-config-loader`, `hard-event-bus`, and `hard-registry-api` come from 2 of the 9 runs only (n=6/arm each).
<!-- RENDER:INTRO:END -->
...
Merged, n=260 per arm — 8 tasks, 2 models, all 9 runs. No `unreleased`-version cells exist yet — all history predates hook_sha capture (`pre-instrumentation`); this will scope to the current version once a new eval run lands.

| Arm | n | Correct | Auto Complete | Judge Completeness | Judge Overcorrection | Turns | Cost/run |
|---|---|---|---|---|---|---|---|
| baseline | 260 | 0.927 | 0.927 | 2.64 | 0.18 | 7.6 | $0.1071 |
| gaslighter-off | 212 | 0.943 | 0.940 | 2.62 | 0.19 | 7.9 | $0.1106 |
| gaslighter-lite | 260 | 0.958 | 0.945 | 2.67 | 0.26 | 8.0 | $0.1425 |
| gaslighter-full | 260 | 0.981 | 0.954 | 2.69 | 0.27 | 10.9 | $0.1514 |
...
|---|---|---|---|---|---|---|---|---|
| hard-buried-constraints | baseline | 58 | 1.000 | 0.927 | 2.38 | 0.33 | 8.8 | $0.1363 |
| hard-buried-constraints | gaslighter-off | 52 | 1.000 | 0.924 | 2.31 | 0.31 | 8.7 | $0.1206 |
| hard-buried-constraints | gaslighter-lite | 58 | 1.000 | 0.927 | 2.22 | 0.24 | 9.3 | $0.1787 |
| hard-buried-constraints | gaslighter-full | 58 | 1.000 | 0.937 | 2.31 | 0.21 | 12.2 | $0.1914 |
...
| hard-cascade-update | baseline | 58 | 0.690 | 0.775 | 2.16 | 0.24 | 11.8 | $0.1228 |
| hard-cascade-update | gaslighter-off | 52 | 0.769 | 0.833 | 2.29 | 0.12 | 12.5 | $0.1350 |
| hard-cascade-update | gaslighter-lite | 58 | 0.810 | 0.833 | 2.43 | 0.29 | 12.8 | $0.1699 |
| hard-cascade-update | gaslighter-full | 58 | 0.914 | 0.870 | 2.50 | 0.21 | 15.9 | $0.1747 |
...
| hard-config-loader | baseline | 6 | 1.000 | 0.980 | 3.00 | 0.33 | 4.2 | $0.0642 |
| hard-config-loader | gaslighter-lite | 6 | 1.000 | 1.000 | 3.00 | 0.17 | 3.8 | $0.0867 |
| hard-config-loader | gaslighter-full | 6 | 1.000 | 0.980 | 3.00 | 0.17 | 6.5 | $0.1007 |
| hard-event-bus | baseline | 6 | 1.000 | 0.910 | 3.00 | 0.17 | 5.0 | $0.0869 |
| hard-event-bus | gaslighter-lite | 6 | 1.000 | 0.925 | 3.00 | 0.67 | 5.2 | $0.1120 |
| hard-event-bus | gaslighter-full | 6 | 1.000 | 0.910 | 3.00 | 0.83 | 7.8 | $0.1357 |
| hard-implicit-patterns | baseline | 42 | 1.000 | 1.000 | 2.98 | 0.07 | 7.1 | $0.0984 |
| hard-implicit-patterns | gaslighter-off | 36 | 1.000 | 1.000 | 2.97 | 0.08 | 6.8 | $0.0949 |
| hard-implicit-patterns | gaslighter-lite | 42 | 1.000 | 1.000 | 3.00 | 0.19 | 7.4 | $0.1263 |
| hard-implicit-patterns | gaslighter-full | 42 | 1.000 | 1.000 | 3.00 | 0.07 | 10.0 | $0.1274 |
...
| hard-preserve-behavior | baseline | 42 | 1.000 | 1.000 | 2.95 | 0.07 | 4.0 | $0.0746 |
| hard-preserve-behavior | gaslighter-off | 36 | 1.000 | 0.996 | 2.92 | 0.17 | 3.9 | $0.0771 |
| hard-preserve-behavior | gaslighter-lite | 42 | 1.000 | 1.000 | 2.95 | 0.26 | 4.4 | $0.1036 |
| hard-preserve-behavior | gaslighter-full | 42 | 1.000 | 0.997 | 2.86 | 0.48 | 7.7 | $0.1180 |
...
| hard-registry-api | baseline | 6 | 1.000 | 1.000 | 3.00 | 0.00 | 5.0 | $0.0584 |
| hard-registry-api | gaslighter-lite | 6 | 1.000 | 1.000 | 3.00 | 0.00 | 4.8 | $0.0863 |
| hard-registry-api | gaslighter-full | 6 | 1.000 | 1.000 | 3.00 | 0.33 | 7.5 | $0.1015 |
| hard-trailing-reqs | baseline | 42 | 0.976 | 0.976 | 2.88 | 0.10 | 5.4 | $0.1022 |
| hard-trailing-reqs | gaslighter-off | 36 | 1.000 | 1.000 | 2.89 | 0.25 | 5.5 | $0.1100 |
| hard-trailing-reqs | gaslighter-lite | 42 | 1.000 | 1.000 | 2.86 | 0.29 | 5.3 | $0.1305 |
| hard-trailing-reqs | gaslighter-full | 42 | 1.000 | 1.000 | 2.88 | 0.38 | 7.9 | $0.1373 |
...
`hard-cascade-update` shows the largest spread in correctness across arms (0.247); every other task varies far less by arm.
