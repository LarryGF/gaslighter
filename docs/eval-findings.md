...
Combined: 1345 cells. `hard-buried-constraints` and `hard-cascade-update` are covered by all 11 runs (n=63/arm each, pooled); `hard-implicit-patterns`, `hard-preserve-behavior`, and `hard-trailing-reqs` come from 10 of the 11 runs only (n=47/arm each); `hard-config-loader`, `hard-event-bus`, and `hard-registry-api` come from 3 of the 11 runs only (n=10/arm each).
<!-- RENDER:INTRO:END -->
...
**Note on sample size:** run counts per cell vary across runs (8, 3, 3, 3, 3, 3, 3, 2, 2, 1, 2), so per-task n varies (63 for `hard-buried-constraints` and `hard-cascade-update`; 47 for `hard-implicit-patterns`, `hard-preserve-behavior`, and `hard-trailing-reqs`; 10 for `hard-config-loader`, `hard-event-bus`, and `hard-registry-api`). Treat single-cell and per-task numbers as directional, especially for the lowest-n tasks.
...
| latest | baseline | 37 | 0.892 | 0.918 | 2.62 | 0.19 | 6.1 | $0.0987 |
| latest | gaslighter-lite | 37 | 0.973 | 0.952 | 2.59 | 0.22 | 7.1 | $0.1151 |
| latest | gaslighter-full | 37 | 0.973 | 0.936 | 2.57 | 0.35 | 10.0 | $0.1550 |
<!-- RENDER:VERSION_HISTORY:END -->

## Headline result

<!-- RENDER:HEADLINE_TABLE:START — auto-generated by evals/render_findings.py, do not hand-edit -->
Scoped to latest (unreleased, since v1.5.0), n=37 per arm — 8 tasks, 2 models — see Version history below for trend across releases.

| Arm | n | Correct | Auto Complete | Judge Completeness | Judge Overcorrection | Turns | Cost/run |
|---|---|---|---|---|---|---|---|
| baseline | 37 | 0.892 | 0.918 | 2.62 | 0.19 | 6.1 | $0.0987 |
| gaslighter-lite | 37 | 0.973 | 0.952 | 2.59 | 0.22 | 7.1 | $0.1151 |
| gaslighter-full | 37 | 0.973 | 0.936 | 2.57 | 0.35 | 10.0 | $0.1550 |
...
|---|---|---|---|---|---|---|---|---|
| hard-buried-constraints | baseline | 5 | 1.000 | 0.940 | 2.40 | 0.00 | 8.8 | $0.1296 |
| hard-buried-constraints | gaslighter-lite | 5 | 1.000 | 0.920 | 2.20 | 0.20 | 8.8 | $0.1408 |
| hard-buried-constraints | gaslighter-full | 5 | 1.000 | 0.920 | 2.00 | 0.40 | 11.6 | $0.1535 |
| hard-cascade-update | baseline | 5 | 0.200 | 0.574 | 1.80 | 0.00 | 9.2 | $0.1486 |
| hard-cascade-update | gaslighter-lite | 5 | 0.800 | 0.850 | 2.60 | 0.20 | 12.6 | $0.1403 |
| hard-cascade-update | gaslighter-full | 5 | 0.800 | 0.702 | 2.00 | 0.00 | 15.2 | $0.2812 |
| hard-config-loader | baseline | 4 | 1.000 | 0.940 | 2.50 | 0.25 | 4.2 | $0.0826 |
| hard-config-loader | gaslighter-lite | 4 | 1.000 | 0.938 | 2.50 | 0.25 | 4.0 | $0.1013 |
| hard-config-loader | gaslighter-full | 4 | 1.000 | 0.970 | 2.75 | 0.25 | 7.5 | $0.1359 |
| hard-event-bus | baseline | 4 | 1.000 | 0.910 | 2.75 | 0.00 | 5.0 | $0.1135 |
| hard-event-bus | gaslighter-lite | 4 | 1.000 | 0.910 | 2.50 | 0.25 | 5.2 | $0.1341 |
| hard-event-bus | gaslighter-full | 4 | 1.000 | 0.910 | 2.25 | 0.50 | 7.8 | $0.1653 |
| hard-implicit-patterns | baseline | 5 | 1.000 | 1.000 | 3.00 | 0.60 | 7.0 | $0.1003 |
| hard-implicit-patterns | gaslighter-lite | 5 | 1.000 | 1.000 | 2.80 | 0.60 | 9.2 | $0.0985 |
| hard-implicit-patterns | gaslighter-full | 5 | 1.000 | 1.000 | 3.00 | 0.60 | 13.2 | $0.1691 |
| hard-preserve-behavior | baseline | 5 | 1.000 | 1.000 | 3.00 | 0.00 | 3.8 | $0.0569 |
| hard-preserve-behavior | gaslighter-lite | 5 | 1.000 | 1.000 | 3.00 | 0.00 | 4.6 | $0.0978 |
| hard-preserve-behavior | gaslighter-full | 5 | 1.000 | 1.000 | 3.00 | 0.20 | 8.8 | $0.1043 |
| hard-registry-api | baseline | 4 | 1.000 | 1.000 | 3.00 | 0.00 | 5.0 | $0.0780 |
| hard-registry-api | gaslighter-lite | 4 | 1.000 | 1.000 | 3.00 | 0.00 | 5.5 | $0.1034 |
| hard-registry-api | gaslighter-full | 4 | 1.000 | 1.000 | 3.00 | 0.00 | 7.5 | $0.1305 |
| hard-trailing-reqs | baseline | 5 | 1.000 | 1.000 | 2.60 | 0.60 | 4.6 | $0.0753 |
| hard-trailing-reqs | gaslighter-lite | 5 | 1.000 | 1.000 | 2.20 | 0.20 | 5.2 | $0.1036 |
| hard-trailing-reqs | gaslighter-full | 5 | 1.000 | 1.000 | 2.60 | 0.80 | 6.8 | $0.0938 |

`hard-cascade-update` shows the largest spread in correctness across arms (0.600); every other task varies far less by arm.
