...
Merged across 9 eval runs (1234 cells total: 8 tasks × 6 arms × 2 models, 8, 3, 3, 3, 3, 3, 3, 2, 2 runs/cell across the runs):

| Arm | Correct | Auto Complete | Judge Completeness | Judge Overcorrection |
|---|---|---|---|---|
| baseline | 0.927 | 0.927 | 2.64 | 0.18 |
| gaslighter-off | 0.943 | 0.940 | 2.62 | 0.19 |
| gaslighter-lite | 0.958 | 0.945 | 2.67 | 0.26 |
| gaslighter-full | 0.981 | 0.954 | 2.69 | 0.27 |
| nudge-prompt | 0.925 | 0.919 | 2.56 | 0.22 |
| gaslighter-smart | 0.933 | 0.942 | 2.60 | 0.10 |
<!-- RENDER:RESULTS_TABLE:END -->

<!-- RENDER:RESULTS_PROSE:START — auto-generated by evals/render_findings.py, do not hand-edit -->
`gaslighter-full` leads on every quality metric — correctness, completion, and judged completeness — at a ~43% turn/cost premium over `baseline`.
