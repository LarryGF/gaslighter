...
Merged across 8 eval runs (1138 cells total: 8 tasks × 6 arms × 2 models, 8, 3, 3, 3, 3, 3, 3, 2 runs/cell across the runs):

| Arm | Correct | Auto Complete | Judge Completeness | Judge Overcorrection |
|---|---|---|---|---|
| baseline | 0.930 | 0.928 | 2.63 | 0.19 |
| gaslighter-off | 0.943 | 0.940 | 2.62 | 0.19 |
| gaslighter-lite | 0.952 | 0.942 | 2.64 | 0.26 |
| gaslighter-full | 0.978 | 0.953 | 2.68 | 0.28 |
...
`gaslighter-full` leads on every quality metric — correctness, completion, and judged completeness — at a ~41% turn/cost premium over `baseline`.
