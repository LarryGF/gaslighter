...
Merged across 1 eval runs (15 cells total: 5 tasks × 3 arms × 1 models, 1 runs/cell across the runs):

| Arm | Correct | Auto Complete | Judge Completeness | Judge Overcorrection |
|---|---|---|---|---|
| baseline | 0.800 | 0.924 | 2.80 | 0.20 |
| gaslighter-lite | 0.800 | 0.830 | 2.20 | 0.20 |
| gaslighter-full | 1.000 | 0.980 | 2.60 | 0.20 |
