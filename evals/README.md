...
|---|---|---|---|---|---|---|
| baseline | 0.927 | 0.927 | 2.64 | 0.18 | 7.6 | $0.1071 |
| gaslighter-off | 0.943 | 0.940 | 2.62 | 0.19 | 7.9 | $0.1106 |
| gaslighter-lite | 0.958 | 0.945 | 2.67 | 0.26 | 8.0 | $0.1425 |
| gaslighter-full | 0.981 | 0.954 | 2.69 | 0.27 | 10.9 | $0.1514 |
...
`gaslighter-full` leads on every quality metric — correctness, completion, and judged completeness — at a ~43% turn/cost premium over `baseline`. The static `nudge-prompt` arm still underperforms both active gaslighter modes on correctness (0.925 vs 0.958/0.981).
