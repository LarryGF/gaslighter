...
Merged across `20260710-124346` (5 tasks × 3 arms × 1 models × 1 runs) — 15 cells total. Full breakdown, per-task tables, and the full per-run appendix (tagged by source run): [`docs/eval-findings.md`](../docs/eval-findings.md).
...
|---|---|---|---|---|---|---|
| baseline | 0.800 | 0.924 | 2.80 | 0.20 | 7.2 | $0.0567 |
| gaslighter-lite | 0.800 | 0.830 | 2.20 | 0.20 | 6.0 | $0.0624 |
| gaslighter-full | 1.000 | 0.980 | 2.60 | 0.20 | 12.2 | $0.1253 |
<!-- RENDER:RESULTS_TABLE:END -->

<!-- RENDER:RESULTS_PROSE:START — auto-generated by evals/render_findings.py, do not hand-edit -->
No single arm leads on every quality metric — per-metric leaders are correct: `gaslighter-full`, auto complete: `gaslighter-full`, judge completeness: `baseline`.
