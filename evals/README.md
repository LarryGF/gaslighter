...
|---|---|---|---|---|---|---|
| baseline | 0.934 | 0.929 | 2.62 | 0.20 | 7.9 | $0.1120 |
| gaslighter-off | 0.943 | 0.940 | 2.62 | 0.19 | 7.9 | $0.1106 |
| gaslighter-lite | 0.948 | 0.939 | 2.62 | 0.24 | 8.2 | $0.1495 |
| gaslighter-full | 0.976 | 0.953 | 2.67 | 0.27 | 11.2 | $0.1573 |
...
`gaslighter-full` leads on every quality metric — correctness, completion, and judged completeness — at a ~41% turn/cost premium over `baseline`. The static `nudge-prompt` arm still underperforms both active gaslighter modes on correctness (0.925 vs 0.948/0.976).
